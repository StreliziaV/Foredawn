...
function monster_catch() {
    if (jsc_monster.offsetTop < 370) {
        ...
        // console.log(distance_x); console.log(distance_y);
    }
    else {
...
function landRun() {
    ...
    if (score >= 5) {
        ...
        fly_continue.onclick = function () {
            ...
            //recover monster
            jsc_monster.style.top = (jsc_monster.offsetTop - distance_y) + "px";
            jsc_monster.style.left = (jsc_monster.offsetLeft - distance_x) + "px";
